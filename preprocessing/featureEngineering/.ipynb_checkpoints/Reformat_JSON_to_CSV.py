...
#          all_ios_attributes = ["Accelerometer", "Analytics", "Brightness", "Call", "Device", "Gyroscope", "Heart_Event", "Heart_Rate", "Location", "Lock state", "Magnetometer", "Mindfulness", "Music", "Noise", "Power state", "Reachability", "Sleep", "Sleep_Noise", "Steps", "Survey", "Weather"]
          ...
          attributes = ["detectedActivityConfidence__inVehicle_onBicycle_onFoot_running_still_tilting_unknown_walking", "connectivity", "sms__numberLetters_phoneNumberHash_smsDate_smsType", "calls__callDate_callDurationS_callType_phoneNumberHash", "powerState"]    ########uncomment this line and change value if single attribute data is required. Make sure its a list. commenting this will fetch data for all the attributes########
